  ...
  const fetcher = useCallback(
    async () =>
      getOutlets({
        ...
        order: params.order,
        searchTermKeys: ['name.contains', 'address.contains', 'phone.contains', 'operating_hours.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('rental_order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'rental_order',
          header: 'Rental Order',
          accessorKey: 'rental_order',
          cell: ({ row: { original: record } }: any) => record?._count?.rental_order,
        }
      : null,
