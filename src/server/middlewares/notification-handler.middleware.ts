...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'rental_order.create': {
    ...
    tenantPath: ['company', 'tool', 'rental_order'],
    userPath: [],
  },
  'tool.update': { roles: ['owner', 'admin'], key: 'tool-update', tenantPath: ['company', 'tool'], userPath: [] },
  'outlet.update': { roles: ['owner', 'admin'], key: 'outlet-update', tenantPath: ['company', 'outlet'], userPath: [] },
};
